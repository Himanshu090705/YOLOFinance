...
const mainListItems = [
  ...
  { text: 'MutualFunds', icon: <AnalyticsRoundedIcon />, path: "/MutualFunds" },
  { text: 'Insaurance', icon: <AnalyticsRoundedIcon />, path: "/Insaurance" },
      ...
      <List dense>
        {mainListItems.map((item, index) => (
          <ListItem key={index} disablePadding sx={{ display: 'block' }} onClick={() => navigate(item.path)}>
            <ListItemButton selected={index === mainListItems[index]}>
